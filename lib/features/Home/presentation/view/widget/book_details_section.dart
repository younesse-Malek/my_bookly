    ...
    return Column(
      children: [
        Padding(
          ...
          child: const CustoumBookimage(imageUrl: 'https://f.hellowork.com/obs-static-images/seo/ObsJob/militaire.jpg',),
        ),
        ...
        const BookReating(mainAxisAlignment: MainAxisAlignment.center, avrgRataing: 0, countRataing: 0,),
